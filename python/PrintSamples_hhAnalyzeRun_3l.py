...
print("Samples_2017: {}".format(len(samples)))

print("sample_category \t\t process_name_specific \t\t sample_name")
for sample_name, sample_info in samples.items():
    #print("\nsample_name: {}, \t category: {}, \t process: {}, \t type: {}".format(sample_name,sample_info["sample_category"], sample_info["process_name_specific"], sample_info["type"]))
    print("{} \t {} \t {}".format(sample_info["sample_category"], sample_info["process_name_specific"], sample_name))
