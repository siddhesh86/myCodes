...
class ExampleAnalysis(Module):
    ...
    def analyze(self, event):
        ...
        # Protection against huge PSWeights observed in TTVV events
        if PSWeight > 5:
            PSWeight = 1 
...
if __name__ == "__main__":
    ...
    with open("%s/tmp_file_ExecutionStarted.txt" % output_dir, 'w') as f:
        f.write("anaHHTo4W_3l_1qq.py: Execution started %s \n" % str(datetime.datetime.now()))
    ...
    print "anaHHTo4W_3l_1qq:: Settings"
    print "pwd: ",os.getcwd()
